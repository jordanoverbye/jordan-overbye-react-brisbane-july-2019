...
<Notes>
1. Thinkmill is a consulting business focused on Design Systems, Platforms & Products, Design & UX, Training
2. Based in Sydney
3. Work Remote
</Notes>
...
[QLD Ballet &nearr;](queenslandballet.com.au/styleguide)<br />
...
# [Tailwind classes from `tw` prop](localhost:3000/tw)
...
```
<div display="flex" mt={2} p={[2, 3]} containter />
